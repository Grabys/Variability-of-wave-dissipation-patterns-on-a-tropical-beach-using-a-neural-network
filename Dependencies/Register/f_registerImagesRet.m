function [MOVINGREG] = f_registerImagesRet(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 26-May-2023
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',782.986111,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',782.986111,'NumOctaves',2,'NumScaleLevels',4);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',51.736111,'MaxRatio',0.517361);
